...
-   **Tabbing/Keyboard Navigation:** The issue with tab navigation remains unresolved after extensive debugging and will be moved to a future story for further investigation and implementation.
-   **Icon Implementation:** A robust solution for button icons (e.g., embedding a font or using an icon library) is still required.
-   **Hotkey UI Implementation:** The "Hotkey Configuration" UI was de-scoped and needs to be implemented in a future story.
